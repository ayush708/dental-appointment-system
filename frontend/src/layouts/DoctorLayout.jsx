...
const DoctorLayout = ({ children }) => {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      icon: CalendarIcon,
      current: location.pathname.startsWith('/doctor/appointments'),
      badge: '5'
    },
    {
      name: 'Patients',
      ...
      icon: UserGroupIcon,
      current: location.pathname.startsWith('/doctor/patients')
    },
    {
      name: 'Schedule',
      href: '/doctor/schedule',
      icon: ClockIcon,
      current: location.pathname.startsWith('/doctor/schedule')
    },
    {
      name: 'Treatments',
      href: '/doctor/treatments',
      icon: ClipboardDocumentListIcon,
      current: location.pathname.startsWith('/doctor/treatments')
    },
    {
      name: 'Messages',
      href: '/doctor/messages',
      icon: ChatBubbleLeftRightIcon,
      current: location.pathname.startsWith('/doctor/messages'),
      badge: '3'
    },
    {
      name: 'Reports',
      ...
      current: location.pathname.startsWith('/doctor/reports')
    },
    {
      name: 'Settings',
      href: '/doctor/settings',
      icon: CogIcon,
      current: location.pathname.startsWith('/doctor/settings')
    }
  ]
    ...
    <div className={`h-screen flex overflow-hidden ${isDarkMode ? 'dark' : ''}`}>
      ...
      <div className="flex flex-col w-0 flex-1 overflow-hidden bg-gray-50 dark:bg-gray-900">
        ...
        <DoctorHeader 
          ...
          onRemindersClick={() => setRemindersPanelOpen(true)}
